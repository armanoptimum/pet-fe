...
import { BannerStyled, BannerContentStyled, BannerHeaderStyled, BannerSubHeaderStyled, BannerParagraphStyled, BannerBtnsStyled, BannerImageContainerStyled } from './styles'
    ...
    <BannerStyled>
        <BannerContentStyled>
            ...
            <BannerParagraphStyled>
                ...
                with you to have fun. We have 200+ different 
                pets that can meet your needs!
            </BannerParagraphStyled>
            <BannerBtnsStyled>
              <Button style={'outline'} icon={arrowRight}>View Intro</Button>
